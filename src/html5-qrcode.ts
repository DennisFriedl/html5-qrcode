...
export class Html5Qrcode {
  ...
  private readonly _rootElement: HTMLElement | null = null;
  ...
  public constructor(
    ...
    if (elementIdOrElement instanceof HTMLElement) {
      this._rootElement = elementIdOrElement;
      this.elementId = null;
    } else {
      if (!document.getElementById(elementIdOrElement)) {
        throw `HTML Element with id=${elementIdOrElement} not found`;
      }
  ...
  /** Returns the root element, resolving by ID if needed. */
  ...
  public start(
    ...
    if (qrCodeErrorCallback) {
      ...
      qrCodeErrorCallbackInternal = this.verbose ? this.logger.log : () => {};
    }
    ...
    return new Promise((resolve, reject) => {
      ...
      CameraFactory.failIfNotSupported()
        .then((factory) => {
          factory
  ...
  public stop(): Promise<void> {
    ...
    const removeQrRegion = () => {
      ...
      let childElement = this.element.querySelector(
  ...
  public scanFileV2(
    ...
    return new Promise((resolve, reject) => {
      ...
      inputImage.onload = () => {
        ...
        try {
          this.qrcode
            .decodeRobustlyAsync(hiddenCanvas)
            .then((result) => {
  ...
  private getUseBarCodeDetectorIfSupported(
    config: Html5QrcodeConfigs | undefined,
  ): boolean {
  ...
  private setupUi(
    ...
    const context: CanvasRenderingContext2D = (<any>canvasElement).getContext(
      "2d",
      contextAttributes,
    )!;
